...
@section('title', 'Login - Tweet Tweet')
...
<div class="max-w-md mx-auto mt-10">
    <div class="bg-white rounded-lg shadow-lg p-8">
        <div class="text-center mb-6">
            ...
            <h2 class="text-2xl font-bold">Sign in to Tweet Tweet</h2>
        </div>
        ...
        <p class="text-center mt-6 text-gray-600">
            ...
            <a href="{{ route('register') }}" class="text-blue-500 hover:text-blue-600 font-semibold">Sign up</a>
        </p>
    </div>
</div>
@endsection